...
const products = [
  ...
  },
  {
    id: 2,
    signal: "02",
    image: withImageWidth(scendentImages.eventCrowd, 1200),
  ...
  return (
    <div className="mt-16 section-animate" id="pillars">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-14 mt-12 md:px-14 px-4">
        {products.map(({ id, image, title, description, href, signal }) => (
          <div key={id} className="relative group overflow-hidden rounded-sm border border-sage-500/25 bg-linen-100/90 shadow-[0_28px_65px_-50px_rgba(0,0,0,0.75)] transition hover:shadow-[0_28px_70px_-45px_rgba(57,255,20,0.22)]">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-linen-100/95 via-linen-50/40 to-transparent opacity-0 group-hover:opacity-100 transition duration-300"></div>
            <div className="absolute top-4 left-4 sc-label text-sage-300 font-accent">Signal {signal}</div>
            <div className="group-hover:-translate-y-3 transition duration-300 absolute bottom-6 left-6 text-ink-900 space-y-2">
