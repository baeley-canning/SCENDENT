  ...
  return (
    <div className="hero-surface section-animate flex flex-col md:flex-row items-center justify-between my-16" id="media">
      <div className="relative flex flex-col items-start justify-center text-left space-y-4 px-6 md:px-12 py-12 md:py-16 max-w-xl">
        ...
        <div className="flex flex-wrap gap-2 text-[10px] uppercase tracking-[0.34em] text-sage-300 font-accent">
          <span className="rounded-sm border border-sage-500/35 bg-linen-100/80 px-3 py-1">
            Strategy + production
          </span>
          <span className="rounded-sm border border-sage-500/35 bg-linen-100/80 px-3 py-1">
            Social systems
      ...
      <div className="relative grid grid-cols-2 sm:grid-cols-3 gap-4 px-6 pb-10 md:pb-0">
        <div className="relative w-40 md:w-44 aspect-[3/4] drop-shadow-[0_20px_50px_rgba(11,14,18,0.25)]">
          <Image
