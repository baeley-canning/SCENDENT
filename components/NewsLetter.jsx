...
const NewsLetter = () => {
  return (
    <div className="flex flex-col items-center justify-center text-center space-y-3 pt-8 pb-14 section-animate" id="contact">
      ...
      <h1 className="md:text-4xl text-2xl font-medium uppercase tracking-[0.18em] font-display">
      ...
      <div className="flex items-center justify-between max-w-2xl w-full md:h-14 h-12">
        <input
          className="border border-sage-500/30 rounded-sm h-full border-r-0 outline-none w-full rounded-r-none px-4 text-ink-700 bg-linen-100/90"
          type="email"
          aria-label="Email address"
          placeholder="Enter your email"
        />
        <button className="md:px-12 px-8 h-full text-linen-50 bg-sage-500 rounded-sm rounded-l-none hover:bg-sage-600 transition text-[11px] uppercase tracking-[0.32em] font-semibold font-accent">
          Get updates
        </button>
      </div>
