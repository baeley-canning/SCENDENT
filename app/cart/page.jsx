    ...
    <>
      ...
      <div className="flex flex-col md:flex-row gap-10 px-6 md:px-16 lg:px-32 pt-14 mb-20">
        <div className="flex-1">
          <div className="flex flex-wrap items-center justify-between gap-4 mb-8 border-b border-ink-900/10 pb-6">
            <div>
            ...
            {cartCount > 0 ? (
              <button
                className="text-xs uppercase tracking-[0.2em] text-ink-500 hover:text-ink-900 transition"
                onClick={clearCart}
              >
                Clear cart
              </button>
          ...
          {cartCount === 0 ? (
            <div className="rounded-[24px] border border-ink-900/10 bg-linen-50/90 p-8 text-center">
            ...
            <>
                      ...
                      return (
                        <tr key={itemId}>
                          <td className="flex items-center gap-4 py-4 md:px-4 px-1">
                            <div>
                              <div className="rounded-xl overflow-hidden bg-linen-50/90 border border-ink-900/10 p-2">
                                <Image
                                  src={product.image[0]}
                                  alt={product.name}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8 text-sm text-ink-700">
                <div className="rounded-[20px] border border-ink-900/10 bg-linen-50/90 p-4">
          ...
          <button onClick={()=> router.push('/all-products')} className="group flex items-center mt-6 gap-2 text-ink-700">
            <Image
