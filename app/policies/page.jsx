      ...
      <main className="px-6 md:px-16 lg:px-32 py-14">
        ...
        <div className="mt-10 space-y-10 max-w-3xl text-sm md:text-base text-ink-500">
          <section className="space-y-3">
            <h2 className="text-xl font-semibold text-ink-900 uppercase tracking-[0.16em] font-display">Returns</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-semibold text-ink-900 uppercase tracking-[0.16em] font-display">Faulty or incorrect items</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-semibold text-ink-900 uppercase tracking-[0.16em] font-display">Consumer Guarantees Act (NZ)</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-semibold text-ink-900 uppercase tracking-[0.16em] font-display">Shipping</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-semibold text-ink-900 uppercase tracking-[0.16em] font-display">Contact</h2>
            <p>
